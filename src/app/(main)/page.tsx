...
const HomePage = async () => {
	...
	return (
		<>
			<section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-56 grainy ">
				<div className="container flex max-w-5xl flex-col items-center gap-4 text-center relative isolate">
